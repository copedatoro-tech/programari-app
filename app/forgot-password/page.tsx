  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 bg-slate-50 font-sans text-slate-900">
      <div className="w-full max-w-md bg-white rounded-[40px] shadow-2xl shadow-slate-200/60 border border-slate-100 overflow-hidden transform hover:scale-[1.01] transition-all duration-500">
        ...
        {/* Header - Identic cu Login - Design Premium Chronos */}
        ...
        <form onSubmit={handleResetPassword} className="p-10 space-y-8 bg-white relative">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
               <input 
                title="Introdu adresa de email asociată contului tău Chronos pentru a primi link-ul de resetare"
                type="email" 
                required 
          ...
          <button 
            type="submit" 
            disabled={loading} 
            title={loading ? "Se procesează cererea..." : "Click pentru a trimite email-ul de resetare"}
          ...
          <div className="text-center pt-8 border-t border-slate-50">
            <Link 
              href="/login" 
              title="Anulează procesul și revino la pagina de autentificare"
